...
<h1 class="table_dark">Hello visitor, please choose category</h1>
<table class="table_dark">
    ...
    <tr><td><a href="${pageContext.request.contextPath}/drivers/cars">Show cars for current Driver</a></td></tr>
</table>
</body>
</html>
